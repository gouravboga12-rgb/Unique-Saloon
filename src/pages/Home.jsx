    ...
    <>
      ...
      <section class="hero" id="hero-section">
        <div class="hero-content">
          <span class="hero-subtitle" data-aos="fade-up" data-aos-delay="100">Premium Hair & Beauty Grooming</span>
          <h1 class="hero-title" data-aos="fade-up" data-aos-delay="200">Transform Your Style with Professional Hair & Beauty Experts</h1>
          <p class="hero-text" data-aos="fade-up" data-aos-delay="300">6+ Years of Excellence in Hair, Beauty, Grooming & Makeup Services in Hyderabad. Affordable luxury tailored for families, brides, and grooming enthusiasts.</p>
